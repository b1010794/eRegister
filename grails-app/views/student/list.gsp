			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="studentFullName" title="${message(code: 'student.studentFullName.label', default: 'Student Full Name')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${studentInstance.id}">${fieldValue(bean: studentInstance, field: "studentFullName")}</g:link></td>
